...
| Fresh report-generation stress check | 100 public receptors were attempted through PDF/protocol/bundle generation; six preparation stops affected by a generic `LINK`-filtering distinction were rerun after correction, and one separate final route required explicit component-removal approval | The initial run produced 79 reports, including the guided 5NBX histidine-template case. Six corrected v0.6.4 regressions and the audited 5KRH removal case bring the retained evidence to 86 complete reports from 100 distinct structures. A single clean v0.6.4 rerun of all 100 remains pending. See the [reconciliation record](receptor-preparation-validation-2026-08-21.md#fresh-report-generation-stress-reconciliation-2026-08-25) and [download the 86-report evidence bundle](https://github.com/thomaslane79-creator/docking-universal/releases/download/v0.6.4/docking-universal-100-pdb-validation-evidence-86-reports.zip). |
