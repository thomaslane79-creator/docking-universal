...
- receptor-preparation robustness sampling across 50 public PDB structures, with 46/50 producing prepared receptors: 10/10 in the original cohort and 36/40 in an additional reproducibly selected cohort;
