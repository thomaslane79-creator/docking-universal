...
def write_pose_browser_pml(output_dir, rows, top_index, best_rmsd_index, contact_cutoff):
    ...
    for index, row in enumerate(rows):
        ...
        lines.extend([
            ...
            f"hide sticks, ({site_object} and hydro and neighbor elem C)",
...
def main():
    ...
    parser.add_argument("--docked-pdbqt", required=True, type=Path, help="Multi-model Vina-family docking output")
